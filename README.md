...
Sample Android app that we use at [rawr](http://rawrenterprises.com) as a reference for new Android projects. It demonstrates the architecture, tools and guidelines that we use when developing for the Android platform
